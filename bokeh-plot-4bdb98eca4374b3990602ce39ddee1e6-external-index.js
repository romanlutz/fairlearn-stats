(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("44d9fdc3-3684-4b40-b0e7-b830bf969ce7");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '44d9fdc3-3684-4b40-b0e7-b830bf969ce7' but no matching script tag was found.")
        }

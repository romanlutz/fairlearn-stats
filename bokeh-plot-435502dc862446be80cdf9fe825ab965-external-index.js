(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("a3582d20-1c4b-4193-bc1a-fb2251b0b3cf");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'a3582d20-1c4b-4193-bc1a-fb2251b0b3cf' but no matching script tag was found.")
        }

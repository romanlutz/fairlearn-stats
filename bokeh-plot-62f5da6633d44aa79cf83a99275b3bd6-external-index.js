(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("7b4907d4-9d0d-4493-8e05-e4505fb5bf27");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '7b4907d4-9d0d-4493-8e05-e4505fb5bf27' but no matching script tag was found.")
        }

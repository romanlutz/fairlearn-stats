(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("77ac2aea-49f0-491d-80e0-64a4a12dc7b5");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '77ac2aea-49f0-491d-80e0-64a4a12dc7b5' but no matching script tag was found.")
        }

(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("6091adb3-b1a4-4efe-90ef-bceb067d5d34");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '6091adb3-b1a4-4efe-90ef-bceb067d5d34' but no matching script tag was found.")
        }

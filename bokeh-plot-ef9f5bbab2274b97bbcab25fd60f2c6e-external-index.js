(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("65661091-7d0f-430e-9d8e-2bf6f2ba25ae");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '65661091-7d0f-430e-9d8e-2bf6f2ba25ae' but no matching script tag was found.")
        }

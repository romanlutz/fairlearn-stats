(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("83bc6928-f188-4854-8d1a-88f32a278374");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '83bc6928-f188-4854-8d1a-88f32a278374' but no matching script tag was found.")
        }

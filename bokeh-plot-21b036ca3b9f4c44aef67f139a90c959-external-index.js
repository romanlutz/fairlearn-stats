(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("b599262c-fbf3-4ce5-9734-355f50f263ae");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b599262c-fbf3-4ce5-9734-355f50f263ae' but no matching script tag was found.")
        }

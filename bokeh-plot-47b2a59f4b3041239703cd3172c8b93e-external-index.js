(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("f24c1a68-75d9-4b3e-a1e1-8cc2315c7814");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'f24c1a68-75d9-4b3e-a1e1-8cc2315c7814' but no matching script tag was found.")
        }

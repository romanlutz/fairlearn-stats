(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("cfe37957-7331-48a2-b5a9-af493f346cf1");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'cfe37957-7331-48a2-b5a9-af493f346cf1' but no matching script tag was found.")
        }

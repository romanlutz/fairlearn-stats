(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("41a8ab6a-87fb-4ff8-8ac0-70f4a69f01f3");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '41a8ab6a-87fb-4ff8-8ac0-70f4a69f01f3' but no matching script tag was found.")
        }

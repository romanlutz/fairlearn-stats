(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("092ca4a0-7f54-49b7-97cf-db98e215f7aa");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '092ca4a0-7f54-49b7-97cf-db98e215f7aa' but no matching script tag was found.")
        }

(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("28835ca1-201b-4a8b-a5c8-d71e672bb286");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '28835ca1-201b-4a8b-a5c8-d71e672bb286' but no matching script tag was found.")
        }

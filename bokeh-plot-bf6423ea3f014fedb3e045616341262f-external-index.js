(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("a2489ff7-8ef5-4765-8dc3-2b5eaff0264f");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'a2489ff7-8ef5-4765-8dc3-2b5eaff0264f' but no matching script tag was found.")
        }

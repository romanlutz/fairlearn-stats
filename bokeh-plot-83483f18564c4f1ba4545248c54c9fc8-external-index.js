(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("ad4acddd-f6ea-48b3-b09c-e0be73a10f7e");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'ad4acddd-f6ea-48b3-b09c-e0be73a10f7e' but no matching script tag was found.")
        }

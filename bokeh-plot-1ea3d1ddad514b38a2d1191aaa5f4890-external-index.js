(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("f6695dc4-d049-4030-aa46-9696f0cc7214");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'f6695dc4-d049-4030-aa46-9696f0cc7214' but no matching script tag was found.")
        }

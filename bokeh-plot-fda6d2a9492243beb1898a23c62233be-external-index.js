(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("d91e735d-8dfa-4ec1-a53a-9268e42ea3c8");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'd91e735d-8dfa-4ec1-a53a-9268e42ea3c8' but no matching script tag was found.")
        }

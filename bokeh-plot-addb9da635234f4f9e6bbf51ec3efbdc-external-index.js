(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("2d0bfec5-220e-4f17-b5de-67d0e2098e28");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '2d0bfec5-220e-4f17-b5de-67d0e2098e28' but no matching script tag was found.")
        }

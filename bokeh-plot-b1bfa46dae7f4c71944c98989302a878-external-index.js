(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("ff9454b7-1324-4b2b-8f7a-e816338285aa");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'ff9454b7-1324-4b2b-8f7a-e816338285aa' but no matching script tag was found.")
        }

(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("f30da117-293a-4abd-a78a-3c2fcd7c0d97");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'f30da117-293a-4abd-a78a-3c2fcd7c0d97' but no matching script tag was found.")
        }

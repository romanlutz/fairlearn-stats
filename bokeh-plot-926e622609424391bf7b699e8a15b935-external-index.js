(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("3be232d5-6540-4060-acf7-1f24b5e847e6");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '3be232d5-6540-4060-acf7-1f24b5e847e6' but no matching script tag was found.")
        }

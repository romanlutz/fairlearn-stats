(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("0fe27d81-df13-4030-a901-454fc556fda8");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '0fe27d81-df13-4030-a901-454fc556fda8' but no matching script tag was found.")
        }

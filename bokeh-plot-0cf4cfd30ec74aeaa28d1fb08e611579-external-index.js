(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("d42bea62-789e-4603-9857-3c24dcdcb212");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'd42bea62-789e-4603-9857-3c24dcdcb212' but no matching script tag was found.")
        }

(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("44783858-c765-497f-b7b4-8779d785f99d");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '44783858-c765-497f-b7b4-8779d785f99d' but no matching script tag was found.")
        }

(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("0c105cd9-0120-4923-8361-5e73bdc66a5e");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '0c105cd9-0120-4923-8361-5e73bdc66a5e' but no matching script tag was found.")
        }

(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("03a493ce-1db6-4080-ba84-104b85dfd444");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '03a493ce-1db6-4080-ba84-104b85dfd444' but no matching script tag was found.")
        }

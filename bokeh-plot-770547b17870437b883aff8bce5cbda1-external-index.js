(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("5a51c9b6-de63-430c-88be-3041929e45a0");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '5a51c9b6-de63-430c-88be-3041929e45a0' but no matching script tag was found.")
        }

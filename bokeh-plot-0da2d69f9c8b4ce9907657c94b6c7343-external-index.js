(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("a9ad7ee8-d37e-4f96-838c-f8735bf5338e");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'a9ad7ee8-d37e-4f96-838c-f8735bf5338e' but no matching script tag was found.")
        }

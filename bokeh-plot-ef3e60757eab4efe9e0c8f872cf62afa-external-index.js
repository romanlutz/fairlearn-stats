(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("e2ee6ea6-31b1-44ad-8563-1591103326fb");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'e2ee6ea6-31b1-44ad-8563-1591103326fb' but no matching script tag was found.")
        }

(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("e5f98bce-396b-42e9-8ad3-15442becddda");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'e5f98bce-396b-42e9-8ad3-15442becddda' but no matching script tag was found.")
        }

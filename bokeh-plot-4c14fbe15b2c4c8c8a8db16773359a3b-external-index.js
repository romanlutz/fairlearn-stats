(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("9ba48fa2-8474-437e-940e-8a5900f41051");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '9ba48fa2-8474-437e-940e-8a5900f41051' but no matching script tag was found.")
        }

(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("1499bebb-5a9b-4e1f-86e8-88d050656bb5");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '1499bebb-5a9b-4e1f-86e8-88d050656bb5' but no matching script tag was found.")
        }

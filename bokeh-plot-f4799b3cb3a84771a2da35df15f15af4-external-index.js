(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("f84789a0-a0ac-40a7-bfcf-dd9216b880fc");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'f84789a0-a0ac-40a7-bfcf-dd9216b880fc' but no matching script tag was found.")
        }

(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("9983d251-f874-4747-a984-38c7e585c382");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '9983d251-f874-4747-a984-38c7e585c382' but no matching script tag was found.")
        }

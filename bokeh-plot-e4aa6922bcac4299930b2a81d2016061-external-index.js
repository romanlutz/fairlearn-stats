(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("a86dbd1b-955b-4571-b61f-524c8aa02f8b");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'a86dbd1b-955b-4571-b61f-524c8aa02f8b' but no matching script tag was found.")
        }

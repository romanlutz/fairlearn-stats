(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("70c5c12d-e363-487d-8e96-aabf4d85d1b6");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '70c5c12d-e363-487d-8e96-aabf4d85d1b6' but no matching script tag was found.")
        }

(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("04668f78-e037-4061-a089-5b31ca2e6fda");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '04668f78-e037-4061-a089-5b31ca2e6fda' but no matching script tag was found.")
        }

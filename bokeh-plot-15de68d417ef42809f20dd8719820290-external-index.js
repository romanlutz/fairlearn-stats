(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("af222315-dc98-4a85-9914-8b9dcf4a4f99");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'af222315-dc98-4a85-9914-8b9dcf4a4f99' but no matching script tag was found.")
        }

(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("c0020906-9369-4fc1-a434-d6089a67617b");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'c0020906-9369-4fc1-a434-d6089a67617b' but no matching script tag was found.")
        }

(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("a7410c1e-a55b-4868-ae54-982bf938b507");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'a7410c1e-a55b-4868-ae54-982bf938b507' but no matching script tag was found.")
        }

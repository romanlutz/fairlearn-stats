(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("d566792b-2d24-46c3-b39c-01db928805c1");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'd566792b-2d24-46c3-b39c-01db928805c1' but no matching script tag was found.")
        }

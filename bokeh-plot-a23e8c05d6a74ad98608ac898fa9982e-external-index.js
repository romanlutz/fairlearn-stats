(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("43591331-1663-4ef1-bd08-6201302e1df3");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '43591331-1663-4ef1-bd08-6201302e1df3' but no matching script tag was found.")
        }

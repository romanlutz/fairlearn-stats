(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("d9c0e854-5d5c-4304-a486-12b19718c343");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'd9c0e854-5d5c-4304-a486-12b19718c343' but no matching script tag was found.")
        }

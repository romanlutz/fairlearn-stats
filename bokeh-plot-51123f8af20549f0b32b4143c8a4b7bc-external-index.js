(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("a2eb95a5-dc05-4303-86f3-6241d5c8397d");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'a2eb95a5-dc05-4303-86f3-6241d5c8397d' but no matching script tag was found.")
        }

(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("52789ac9-e512-4124-a139-5cf905c5d580");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '52789ac9-e512-4124-a139-5cf905c5d580' but no matching script tag was found.")
        }

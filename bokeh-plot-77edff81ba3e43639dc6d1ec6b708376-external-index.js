(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("1baebb71-93d4-46cb-acce-104238daca21");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '1baebb71-93d4-46cb-acce-104238daca21' but no matching script tag was found.")
        }

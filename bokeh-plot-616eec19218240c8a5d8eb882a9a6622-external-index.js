(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("4e9b5404-d09a-40a9-9d29-79b4079cc4db");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '4e9b5404-d09a-40a9-9d29-79b4079cc4db' but no matching script tag was found.")
        }

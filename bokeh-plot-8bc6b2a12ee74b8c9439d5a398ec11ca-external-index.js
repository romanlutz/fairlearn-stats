(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("8cb726c7-08ad-4ee4-aa2c-7790ca955bad");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '8cb726c7-08ad-4ee4-aa2c-7790ca955bad' but no matching script tag was found.")
        }

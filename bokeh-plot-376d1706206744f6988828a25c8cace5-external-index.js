(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("50aafeba-562c-425e-9880-53390c4fecfa");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '50aafeba-562c-425e-9880-53390c4fecfa' but no matching script tag was found.")
        }

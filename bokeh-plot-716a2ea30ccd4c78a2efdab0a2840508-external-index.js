(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("49b7a4e9-e8b8-4778-bf18-7faacd6abb23");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '49b7a4e9-e8b8-4778-bf18-7faacd6abb23' but no matching script tag was found.")
        }

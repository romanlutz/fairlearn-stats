(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("42f109ec-21ea-4d63-80ee-6d3b79fcca23");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '42f109ec-21ea-4d63-80ee-6d3b79fcca23' but no matching script tag was found.")
        }

(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("5990902e-892a-4ed6-b65d-6429e36b793d");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '5990902e-892a-4ed6-b65d-6429e36b793d' but no matching script tag was found.")
        }

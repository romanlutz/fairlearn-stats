(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("649566b6-2a9e-4673-ae94-8d66477879e4");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '649566b6-2a9e-4673-ae94-8d66477879e4' but no matching script tag was found.")
        }

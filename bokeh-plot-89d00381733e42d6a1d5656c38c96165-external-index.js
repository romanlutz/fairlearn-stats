(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("3559264b-5fe5-4812-8edb-dfa124a7adfd");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '3559264b-5fe5-4812-8edb-dfa124a7adfd' but no matching script tag was found.")
        }

(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("a1b62557-bacf-4443-9369-9fc9b6a06530");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'a1b62557-bacf-4443-9369-9fc9b6a06530' but no matching script tag was found.")
        }

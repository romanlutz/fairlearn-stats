(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("8e410a7c-9bb4-4928-a268-bfef7544d4c3");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '8e410a7c-9bb4-4928-a268-bfef7544d4c3' but no matching script tag was found.")
        }

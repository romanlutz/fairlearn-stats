(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("b2dd5ddd-5820-4fd5-a347-201a17c5884e");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b2dd5ddd-5820-4fd5-a347-201a17c5884e' but no matching script tag was found.")
        }

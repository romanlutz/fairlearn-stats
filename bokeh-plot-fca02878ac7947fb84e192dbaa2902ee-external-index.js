(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("5e89b8cd-d9b2-40c1-abc0-e7dcbe986a0c");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '5e89b8cd-d9b2-40c1-abc0-e7dcbe986a0c' but no matching script tag was found.")
        }

(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("ee03b5ba-82ae-460b-8370-2d36fb320b7a");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'ee03b5ba-82ae-460b-8370-2d36fb320b7a' but no matching script tag was found.")
        }

(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("25bb8347-c4b1-4b86-a8dc-45ac034d1251");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '25bb8347-c4b1-4b86-a8dc-45ac034d1251' but no matching script tag was found.")
        }

(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("a5c3b7eb-a86d-4037-a055-dab06431eb1a");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'a5c3b7eb-a86d-4037-a055-dab06431eb1a' but no matching script tag was found.")
        }

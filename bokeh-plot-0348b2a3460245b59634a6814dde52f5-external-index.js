(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("4932d4ce-4464-470e-8416-922473695f03");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '4932d4ce-4464-470e-8416-922473695f03' but no matching script tag was found.")
        }

(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("6482c68f-4dd1-49b5-b05f-98a7659bddc6");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '6482c68f-4dd1-49b5-b05f-98a7659bddc6' but no matching script tag was found.")
        }

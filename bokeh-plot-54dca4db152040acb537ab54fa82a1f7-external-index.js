(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("a2a0730d-59af-48d9-9f31-3c7446b90246");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'a2a0730d-59af-48d9-9f31-3c7446b90246' but no matching script tag was found.")
        }

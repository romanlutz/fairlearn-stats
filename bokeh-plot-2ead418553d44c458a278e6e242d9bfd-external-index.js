(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("10322954-a85a-41c7-8465-e017eca66acc");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '10322954-a85a-41c7-8465-e017eca66acc' but no matching script tag was found.")
        }

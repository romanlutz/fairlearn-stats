(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("7bd62ab3-c60e-4391-94ae-df4256aa9974");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '7bd62ab3-c60e-4391-94ae-df4256aa9974' but no matching script tag was found.")
        }

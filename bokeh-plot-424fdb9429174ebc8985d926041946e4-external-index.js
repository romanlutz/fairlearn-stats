(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("1d6fb903-860c-41fc-afaa-82349bbf4432");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '1d6fb903-860c-41fc-afaa-82349bbf4432' but no matching script tag was found.")
        }

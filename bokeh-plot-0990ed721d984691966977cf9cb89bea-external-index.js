(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("e9b5ba46-6405-4196-b225-5c44d59dc2fe");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'e9b5ba46-6405-4196-b225-5c44d59dc2fe' but no matching script tag was found.")
        }

(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("444847ec-21ee-4320-aa4a-52ebfcb93c92");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '444847ec-21ee-4320-aa4a-52ebfcb93c92' but no matching script tag was found.")
        }

(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("44bc67a2-0d0c-4c27-b130-26ad459bf3d0");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '44bc67a2-0d0c-4c27-b130-26ad459bf3d0' but no matching script tag was found.")
        }

(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("f84f26b5-668c-4ec2-a7e2-dffcd53b5bcd");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'f84f26b5-668c-4ec2-a7e2-dffcd53b5bcd' but no matching script tag was found.")
        }

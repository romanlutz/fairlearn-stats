(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("3407470b-b91a-4105-8d1e-89f6cd3444f9");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '3407470b-b91a-4105-8d1e-89f6cd3444f9' but no matching script tag was found.")
        }

(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("ddd8432f-cdea-4849-adb4-f09ab3ab1743");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'ddd8432f-cdea-4849-adb4-f09ab3ab1743' but no matching script tag was found.")
        }

(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("9799f756-f6e8-4410-b316-8add8cceda73");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '9799f756-f6e8-4410-b316-8add8cceda73' but no matching script tag was found.")
        }

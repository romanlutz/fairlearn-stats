(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("4a1d96c6-dd26-4171-bafe-9dd2d75f68a4");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '4a1d96c6-dd26-4171-bafe-9dd2d75f68a4' but no matching script tag was found.")
        }

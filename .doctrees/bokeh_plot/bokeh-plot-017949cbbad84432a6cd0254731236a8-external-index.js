(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("6fab4965-6105-4ca5-8d65-c34f5582440b");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '6fab4965-6105-4ca5-8d65-c34f5582440b' but no matching script tag was found.")
        }

(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("22a54328-40d6-43fe-b6ba-58a923fd1e97");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '22a54328-40d6-43fe-b6ba-58a923fd1e97' but no matching script tag was found.")
        }

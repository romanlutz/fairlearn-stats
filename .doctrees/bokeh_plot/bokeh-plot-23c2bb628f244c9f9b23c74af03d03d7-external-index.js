(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("f6977211-ccb1-4e9c-b297-e1ec3a9a8393");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'f6977211-ccb1-4e9c-b297-e1ec3a9a8393' but no matching script tag was found.")
        }

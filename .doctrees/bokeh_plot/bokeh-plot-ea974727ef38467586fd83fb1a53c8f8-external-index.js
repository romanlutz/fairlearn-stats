(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("f6cecc67-9f73-4d16-90e5-b6fea9d8fd11");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'f6cecc67-9f73-4d16-90e5-b6fea9d8fd11' but no matching script tag was found.")
        }

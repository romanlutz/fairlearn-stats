(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("6ee791b5-4717-4256-b664-e09aa620e1c0");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '6ee791b5-4717-4256-b664-e09aa620e1c0' but no matching script tag was found.")
        }

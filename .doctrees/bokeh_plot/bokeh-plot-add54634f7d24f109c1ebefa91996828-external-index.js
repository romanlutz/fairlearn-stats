(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("2774f026-684e-4133-93e4-ce4a10c3d59e");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '2774f026-684e-4133-93e4-ce4a10c3d59e' but no matching script tag was found.")
        }

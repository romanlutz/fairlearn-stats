(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("0e4a9827-be5c-46a3-8733-042dba084f93");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '0e4a9827-be5c-46a3-8733-042dba084f93' but no matching script tag was found.")
        }

(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("f9bd8b48-d0c2-42db-9e90-94c236fc1942");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'f9bd8b48-d0c2-42db-9e90-94c236fc1942' but no matching script tag was found.")
        }

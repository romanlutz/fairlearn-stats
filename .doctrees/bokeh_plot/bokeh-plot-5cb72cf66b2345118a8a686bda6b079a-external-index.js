(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("2d0a25c3-5c0d-437b-92a5-7d32d3af51ed");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '2d0a25c3-5c0d-437b-92a5-7d32d3af51ed' but no matching script tag was found.")
        }

(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("694eaa12-9b28-4aa8-8350-d9a2e45b206d");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '694eaa12-9b28-4aa8-8350-d9a2e45b206d' but no matching script tag was found.")
        }

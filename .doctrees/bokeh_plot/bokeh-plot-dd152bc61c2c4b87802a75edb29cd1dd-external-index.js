(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("f9caf713-e6f1-48d9-a423-51a4f89ba446");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'f9caf713-e6f1-48d9-a423-51a4f89ba446' but no matching script tag was found.")
        }

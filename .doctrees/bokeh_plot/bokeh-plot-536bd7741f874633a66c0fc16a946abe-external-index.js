(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("7ecc138b-08c9-463c-81a0-cb5834ebb213");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '7ecc138b-08c9-463c-81a0-cb5834ebb213' but no matching script tag was found.")
        }

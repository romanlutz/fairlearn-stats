(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("d5a5e0fa-5799-44dc-a73b-47775d7686d9");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'd5a5e0fa-5799-44dc-a73b-47775d7686d9' but no matching script tag was found.")
        }

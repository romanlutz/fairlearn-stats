(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("7686b9b6-2833-446b-8fc6-9d6f9f7d07a8");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '7686b9b6-2833-446b-8fc6-9d6f9f7d07a8' but no matching script tag was found.")
        }

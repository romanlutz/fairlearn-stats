(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("7deec103-eb55-48cb-b524-b4ab4faafffb");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '7deec103-eb55-48cb-b524-b4ab4faafffb' but no matching script tag was found.")
        }

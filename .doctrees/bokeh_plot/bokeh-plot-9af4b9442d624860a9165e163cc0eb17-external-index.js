(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("b281c08e-912b-462d-95b0-fc7bdfe67483");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b281c08e-912b-462d-95b0-fc7bdfe67483' but no matching script tag was found.")
        }

(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("a877bdc2-4941-40a5-8d7f-30441de138d2");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'a877bdc2-4941-40a5-8d7f-30441de138d2' but no matching script tag was found.")
        }

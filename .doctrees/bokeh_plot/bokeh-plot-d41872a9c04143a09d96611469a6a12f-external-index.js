(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("f34efc76-9415-46ea-bb40-7c5b9461a228");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'f34efc76-9415-46ea-bb40-7c5b9461a228' but no matching script tag was found.")
        }

(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("1eb8b45b-bac1-44e6-bd2b-cef5b5b72950");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '1eb8b45b-bac1-44e6-bd2b-cef5b5b72950' but no matching script tag was found.")
        }

(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("58323281-b3f7-4293-a6be-3d77c6f118ac");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '58323281-b3f7-4293-a6be-3d77c6f118ac' but no matching script tag was found.")
        }

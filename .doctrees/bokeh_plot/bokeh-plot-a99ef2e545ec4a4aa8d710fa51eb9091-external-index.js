(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("ec7cb44f-031c-4576-b6d0-e5c41580db95");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'ec7cb44f-031c-4576-b6d0-e5c41580db95' but no matching script tag was found.")
        }

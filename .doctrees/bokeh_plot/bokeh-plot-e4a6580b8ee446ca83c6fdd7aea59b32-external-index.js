(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("17a7e168-fa45-4bd5-a3c4-7938ba965f35");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '17a7e168-fa45-4bd5-a3c4-7938ba965f35' but no matching script tag was found.")
        }

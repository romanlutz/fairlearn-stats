(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("4f98323d-6621-4d3f-b7d1-56f15225feea");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '4f98323d-6621-4d3f-b7d1-56f15225feea' but no matching script tag was found.")
        }

(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("6863facf-ce11-4963-834a-df38c0332378");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '6863facf-ce11-4963-834a-df38c0332378' but no matching script tag was found.")
        }

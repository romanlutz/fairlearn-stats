(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("ff82e860-9473-4850-9da5-916badd5ddbf");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'ff82e860-9473-4850-9da5-916badd5ddbf' but no matching script tag was found.")
        }

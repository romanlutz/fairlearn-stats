(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("4c8396d9-0250-42d5-bba9-772194a5e896");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '4c8396d9-0250-42d5-bba9-772194a5e896' but no matching script tag was found.")
        }

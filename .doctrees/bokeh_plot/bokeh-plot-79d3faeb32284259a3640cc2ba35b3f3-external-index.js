(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("1023eeab-26bf-45ff-b26a-963304defd8a");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '1023eeab-26bf-45ff-b26a-963304defd8a' but no matching script tag was found.")
        }

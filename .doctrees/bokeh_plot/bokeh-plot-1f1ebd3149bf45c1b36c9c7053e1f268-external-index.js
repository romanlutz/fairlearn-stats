(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("de136fb7-1254-44c1-81a0-77227fc43a46");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'de136fb7-1254-44c1-81a0-77227fc43a46' but no matching script tag was found.")
        }

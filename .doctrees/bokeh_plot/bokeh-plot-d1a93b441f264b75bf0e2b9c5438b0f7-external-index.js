(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("b2ae2fe9-b7e7-49fd-8b18-ef20b77b8b98");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b2ae2fe9-b7e7-49fd-8b18-ef20b77b8b98' but no matching script tag was found.")
        }

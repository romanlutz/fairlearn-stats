(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("c1a1f4f0-e8e9-4565-bdd3-88d154ecedd6");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'c1a1f4f0-e8e9-4565-bdd3-88d154ecedd6' but no matching script tag was found.")
        }

(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("dd3d1129-3fa5-45fa-821a-30b29be7af31");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'dd3d1129-3fa5-45fa-821a-30b29be7af31' but no matching script tag was found.")
        }

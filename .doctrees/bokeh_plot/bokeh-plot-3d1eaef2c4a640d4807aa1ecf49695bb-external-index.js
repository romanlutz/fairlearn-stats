(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("2647b947-5671-4ba1-962c-7341014c65f5");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '2647b947-5671-4ba1-962c-7341014c65f5' but no matching script tag was found.")
        }

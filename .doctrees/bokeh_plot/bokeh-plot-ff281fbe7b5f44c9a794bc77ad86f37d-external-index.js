(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("fc8404ce-bf1c-43eb-b8b3-c594995528e8");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'fc8404ce-bf1c-43eb-b8b3-c594995528e8' but no matching script tag was found.")
        }

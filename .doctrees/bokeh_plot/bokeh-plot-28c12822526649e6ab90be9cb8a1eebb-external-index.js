(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("1efe8671-b018-4cb6-9553-dd062876de5f");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '1efe8671-b018-4cb6-9553-dd062876de5f' but no matching script tag was found.")
        }

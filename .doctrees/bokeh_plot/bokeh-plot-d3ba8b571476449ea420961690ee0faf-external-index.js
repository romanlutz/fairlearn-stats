(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("46f368f1-d0b8-4a1e-8a02-0406774e7adb");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '46f368f1-d0b8-4a1e-8a02-0406774e7adb' but no matching script tag was found.")
        }

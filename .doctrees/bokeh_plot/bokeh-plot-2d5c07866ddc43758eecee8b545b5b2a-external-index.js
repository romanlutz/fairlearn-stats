(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("257d5078-f345-4ddd-ba0d-8606f571519e");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '257d5078-f345-4ddd-ba0d-8606f571519e' but no matching script tag was found.")
        }

(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("f497f1a5-9cc6-4391-b565-8cb28fbaf722");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'f497f1a5-9cc6-4391-b565-8cb28fbaf722' but no matching script tag was found.")
        }

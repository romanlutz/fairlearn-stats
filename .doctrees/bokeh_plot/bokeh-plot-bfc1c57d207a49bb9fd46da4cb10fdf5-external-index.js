(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("f6eda75d-9932-4856-ad86-f9cd64bc217d");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'f6eda75d-9932-4856-ad86-f9cd64bc217d' but no matching script tag was found.")
        }

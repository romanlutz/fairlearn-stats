(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("2cf63ffa-caf4-46fc-a8f3-5eee042ea457");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '2cf63ffa-caf4-46fc-a8f3-5eee042ea457' but no matching script tag was found.")
        }

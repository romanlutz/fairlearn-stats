(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("33174427-91db-461f-8e36-6fe89eeda883");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '33174427-91db-461f-8e36-6fe89eeda883' but no matching script tag was found.")
        }

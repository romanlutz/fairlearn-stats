(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("395395a3-7b59-4fe9-ac3f-052797890557");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '395395a3-7b59-4fe9-ac3f-052797890557' but no matching script tag was found.")
        }

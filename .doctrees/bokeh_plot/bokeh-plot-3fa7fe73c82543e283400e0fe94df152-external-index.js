(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("c2c8f090-9e5c-44b8-8003-aa74cf865fbe");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'c2c8f090-9e5c-44b8-8003-aa74cf865fbe' but no matching script tag was found.")
        }

(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("a4aee966-c097-4919-99ad-b0dbeca9add9");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'a4aee966-c097-4919-99ad-b0dbeca9add9' but no matching script tag was found.")
        }

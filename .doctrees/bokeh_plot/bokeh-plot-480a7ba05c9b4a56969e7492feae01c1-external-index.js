(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("4b9ee0c2-e2b8-4987-ab76-32b46eb4c7dd");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '4b9ee0c2-e2b8-4987-ab76-32b46eb4c7dd' but no matching script tag was found.")
        }

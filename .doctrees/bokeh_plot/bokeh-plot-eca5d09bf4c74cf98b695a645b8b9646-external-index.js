(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("0f781ab4-3566-4012-97d5-8e7d525f035b");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '0f781ab4-3566-4012-97d5-8e7d525f035b' but no matching script tag was found.")
        }

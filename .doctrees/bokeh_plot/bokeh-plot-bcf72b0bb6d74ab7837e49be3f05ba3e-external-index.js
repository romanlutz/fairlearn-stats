(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("98895a75-e0b1-47fe-a59f-4edc46a84ec0");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '98895a75-e0b1-47fe-a59f-4edc46a84ec0' but no matching script tag was found.")
        }

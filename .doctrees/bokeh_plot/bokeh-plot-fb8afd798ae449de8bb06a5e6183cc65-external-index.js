(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("55cd66cb-ebff-49ec-87b9-e0a3f5df21bd");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '55cd66cb-ebff-49ec-87b9-e0a3f5df21bd' but no matching script tag was found.")
        }

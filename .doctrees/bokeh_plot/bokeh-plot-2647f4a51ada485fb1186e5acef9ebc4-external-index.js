(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("023feb2a-9b34-4592-a66d-55780a9b7c5c");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '023feb2a-9b34-4592-a66d-55780a9b7c5c' but no matching script tag was found.")
        }

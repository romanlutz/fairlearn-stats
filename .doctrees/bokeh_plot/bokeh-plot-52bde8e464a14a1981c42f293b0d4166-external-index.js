(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("ae21be05-06b1-4483-986a-782975dd3cb9");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'ae21be05-06b1-4483-986a-782975dd3cb9' but no matching script tag was found.")
        }

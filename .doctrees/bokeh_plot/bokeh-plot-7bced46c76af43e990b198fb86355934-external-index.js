(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("0abaff68-ee82-468f-baa4-9c14f9624a80");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '0abaff68-ee82-468f-baa4-9c14f9624a80' but no matching script tag was found.")
        }

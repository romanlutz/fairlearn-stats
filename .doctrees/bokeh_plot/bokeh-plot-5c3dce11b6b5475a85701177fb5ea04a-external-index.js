(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("d2c2b604-5ec3-44fe-8442-e6a57a376480");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'd2c2b604-5ec3-44fe-8442-e6a57a376480' but no matching script tag was found.")
        }

(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("d14edf63-cd72-48da-a636-01bd3e2d0c1e");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'd14edf63-cd72-48da-a636-01bd3e2d0c1e' but no matching script tag was found.")
        }

(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("b76eb890-95e9-455b-af7c-291a424c68aa");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b76eb890-95e9-455b-af7c-291a424c68aa' but no matching script tag was found.")
        }

(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("ffc7479a-9d07-4d36-adbc-71456c8c28de");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'ffc7479a-9d07-4d36-adbc-71456c8c28de' but no matching script tag was found.")
        }

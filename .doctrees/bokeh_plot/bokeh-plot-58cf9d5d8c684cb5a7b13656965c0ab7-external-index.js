(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("1d74cacb-b65d-4481-8748-ffadd71d1995");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '1d74cacb-b65d-4481-8748-ffadd71d1995' but no matching script tag was found.")
        }

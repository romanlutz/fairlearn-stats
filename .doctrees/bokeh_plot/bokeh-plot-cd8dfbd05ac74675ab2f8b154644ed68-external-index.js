(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("6063d36d-a870-46f7-b256-29de4931860f");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '6063d36d-a870-46f7-b256-29de4931860f' but no matching script tag was found.")
        }

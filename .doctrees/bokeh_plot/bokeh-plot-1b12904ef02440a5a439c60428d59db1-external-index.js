(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("9b9d6252-28ec-44a3-bbea-ef12efbf8255");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '9b9d6252-28ec-44a3-bbea-ef12efbf8255' but no matching script tag was found.")
        }

(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("9096acc1-0eb9-485a-9a9b-7cd6898def32");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '9096acc1-0eb9-485a-9a9b-7cd6898def32' but no matching script tag was found.")
        }

(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("0d8d1b5c-36dd-498e-a848-542415342524");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '0d8d1b5c-36dd-498e-a848-542415342524' but no matching script tag was found.")
        }

(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("07c145fa-317e-4933-9710-e0c71c54aa29");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '07c145fa-317e-4933-9710-e0c71c54aa29' but no matching script tag was found.")
        }

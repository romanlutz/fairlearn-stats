(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("61baddfd-b17a-4133-8403-6af8a6189d6f");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '61baddfd-b17a-4133-8403-6af8a6189d6f' but no matching script tag was found.")
        }

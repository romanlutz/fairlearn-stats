(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("958ce8b0-e470-4271-b3d4-382c9ffc4f61");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '958ce8b0-e470-4271-b3d4-382c9ffc4f61' but no matching script tag was found.")
        }

(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("2cc8642e-7ea7-4081-95b3-d795fe7c3ed0");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '2cc8642e-7ea7-4081-95b3-d795fe7c3ed0' but no matching script tag was found.")
        }

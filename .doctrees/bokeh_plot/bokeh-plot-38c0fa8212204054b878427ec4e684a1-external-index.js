(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("6cfbc011-6d85-42ef-874d-b630a69a7ada");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '6cfbc011-6d85-42ef-874d-b630a69a7ada' but no matching script tag was found.")
        }

(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("ae4b1ffe-0893-4f13-88eb-d666d8e7c9b1");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'ae4b1ffe-0893-4f13-88eb-d666d8e7c9b1' but no matching script tag was found.")
        }

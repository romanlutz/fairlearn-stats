(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("1e885bb6-45d5-4337-bb20-c3c8624d604c");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '1e885bb6-45d5-4337-bb20-c3c8624d604c' but no matching script tag was found.")
        }

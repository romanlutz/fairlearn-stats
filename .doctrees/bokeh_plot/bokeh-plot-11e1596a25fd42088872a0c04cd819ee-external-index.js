(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("664c8fc7-da51-4416-9048-bd0cb8f42d09");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '664c8fc7-da51-4416-9048-bd0cb8f42d09' but no matching script tag was found.")
        }

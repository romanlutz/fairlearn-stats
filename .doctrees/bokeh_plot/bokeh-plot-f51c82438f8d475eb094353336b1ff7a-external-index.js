(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("d0019712-0e80-4c99-9dba-e82a94a022ed");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'd0019712-0e80-4c99-9dba-e82a94a022ed' but no matching script tag was found.")
        }

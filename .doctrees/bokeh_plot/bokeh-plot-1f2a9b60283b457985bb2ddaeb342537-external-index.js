(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("347cbc0b-24c8-4393-bebb-084974bf6893");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '347cbc0b-24c8-4393-bebb-084974bf6893' but no matching script tag was found.")
        }

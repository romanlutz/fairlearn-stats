(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("e68596ae-b0b5-41a5-b358-1e4ed4af2e5d");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'e68596ae-b0b5-41a5-b358-1e4ed4af2e5d' but no matching script tag was found.")
        }

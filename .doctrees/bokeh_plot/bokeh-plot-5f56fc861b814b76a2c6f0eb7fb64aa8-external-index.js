(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("ff880e6e-5787-4c3e-ade0-d32542b743bb");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'ff880e6e-5787-4c3e-ade0-d32542b743bb' but no matching script tag was found.")
        }

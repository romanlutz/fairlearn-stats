(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("b9192a59-17de-4af6-9dbf-89519a638b97");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b9192a59-17de-4af6-9dbf-89519a638b97' but no matching script tag was found.")
        }

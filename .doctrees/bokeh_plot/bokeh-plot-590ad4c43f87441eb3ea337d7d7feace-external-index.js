(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("8a9c4fe5-9552-4440-9148-6aa1b1dd5d5a");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '8a9c4fe5-9552-4440-9148-6aa1b1dd5d5a' but no matching script tag was found.")
        }

(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("4d4a4b7d-be35-4028-9a04-b5dd922ba9a4");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '4d4a4b7d-be35-4028-9a04-b5dd922ba9a4' but no matching script tag was found.")
        }

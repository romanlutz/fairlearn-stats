(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("c53ce8e8-9980-4c02-8556-7a9b10bde969");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'c53ce8e8-9980-4c02-8556-7a9b10bde969' but no matching script tag was found.")
        }

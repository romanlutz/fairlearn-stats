(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("26acc610-69da-494a-a9d3-f26606249846");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '26acc610-69da-494a-a9d3-f26606249846' but no matching script tag was found.")
        }

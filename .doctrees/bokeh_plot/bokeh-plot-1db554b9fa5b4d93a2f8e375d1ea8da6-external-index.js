(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("080f79b8-fca2-4538-99f0-275c0c84a235");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '080f79b8-fca2-4538-99f0-275c0c84a235' but no matching script tag was found.")
        }

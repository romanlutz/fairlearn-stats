(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("bb639465-a6b4-4381-99c5-0605f854cabb");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'bb639465-a6b4-4381-99c5-0605f854cabb' but no matching script tag was found.")
        }

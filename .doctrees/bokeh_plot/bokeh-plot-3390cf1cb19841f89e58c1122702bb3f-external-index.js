(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("0ffc8cf9-fe9a-4d02-ab72-cc1b2926bf3a");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '0ffc8cf9-fe9a-4d02-ab72-cc1b2926bf3a' but no matching script tag was found.")
        }

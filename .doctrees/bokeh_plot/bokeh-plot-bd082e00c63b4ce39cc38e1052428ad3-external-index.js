(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("42bd2aa3-e76b-4535-82f4-9adc3dd11760");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '42bd2aa3-e76b-4535-82f4-9adc3dd11760' but no matching script tag was found.")
        }

(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("1de3b17a-fadc-47dd-bdfe-c303868b23b1");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '1de3b17a-fadc-47dd-bdfe-c303868b23b1' but no matching script tag was found.")
        }

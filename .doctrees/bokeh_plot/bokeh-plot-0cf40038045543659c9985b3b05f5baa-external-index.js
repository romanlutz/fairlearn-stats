(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("480b7a0c-e427-4ed0-b657-9611b89de92d");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '480b7a0c-e427-4ed0-b657-9611b89de92d' but no matching script tag was found.")
        }

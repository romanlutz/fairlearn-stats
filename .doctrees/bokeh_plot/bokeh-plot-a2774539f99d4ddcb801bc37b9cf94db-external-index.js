(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("149bdd2f-1717-4a70-97da-5b0521878d67");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '149bdd2f-1717-4a70-97da-5b0521878d67' but no matching script tag was found.")
        }

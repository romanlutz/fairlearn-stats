(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("161d8247-a853-42f5-bf42-97bb48d1dc48");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '161d8247-a853-42f5-bf42-97bb48d1dc48' but no matching script tag was found.")
        }

(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("1c4fdf08-daea-44b8-b31f-fc0d2fd0eb09");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '1c4fdf08-daea-44b8-b31f-fc0d2fd0eb09' but no matching script tag was found.")
        }

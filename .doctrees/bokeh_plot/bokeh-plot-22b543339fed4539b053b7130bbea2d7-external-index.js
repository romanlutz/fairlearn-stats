(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("fbf43a95-bd19-45e6-afcd-dbabab06164b");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'fbf43a95-bd19-45e6-afcd-dbabab06164b' but no matching script tag was found.")
        }

(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("02c5a797-6853-4835-985c-28957a2be9da");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '02c5a797-6853-4835-985c-28957a2be9da' but no matching script tag was found.")
        }

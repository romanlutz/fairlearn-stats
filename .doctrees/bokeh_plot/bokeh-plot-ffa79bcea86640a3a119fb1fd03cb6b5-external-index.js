(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("d5b942e3-e2d0-484b-9592-e41341cabce3");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'd5b942e3-e2d0-484b-9592-e41341cabce3' but no matching script tag was found.")
        }

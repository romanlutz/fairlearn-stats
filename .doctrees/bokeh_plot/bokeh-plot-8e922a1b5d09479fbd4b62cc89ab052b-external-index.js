(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("1848066c-f1c9-47f2-b44f-0dd8ed4b455c");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '1848066c-f1c9-47f2-b44f-0dd8ed4b455c' but no matching script tag was found.")
        }

(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("8869c142-505f-41bf-98bf-443b233b7b82");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '8869c142-505f-41bf-98bf-443b233b7b82' but no matching script tag was found.")
        }

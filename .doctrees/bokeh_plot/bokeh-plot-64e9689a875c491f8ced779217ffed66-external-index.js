(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("1d5018fe-1259-473c-ab0c-e25f6e88ae7c");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '1d5018fe-1259-473c-ab0c-e25f6e88ae7c' but no matching script tag was found.")
        }

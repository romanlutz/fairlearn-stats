(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("c6c25058-913f-48d8-bfd0-0791f78ccb84");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'c6c25058-913f-48d8-bfd0-0791f78ccb84' but no matching script tag was found.")
        }

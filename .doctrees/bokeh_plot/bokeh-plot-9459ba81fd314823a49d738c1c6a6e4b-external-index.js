(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("0171bb7a-7118-4a43-80c3-ca9b755ba3f5");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '0171bb7a-7118-4a43-80c3-ca9b755ba3f5' but no matching script tag was found.")
        }

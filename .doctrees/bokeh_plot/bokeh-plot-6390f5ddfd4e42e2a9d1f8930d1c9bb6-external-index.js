(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("de090ccf-2ed8-4d8d-8886-8737349331f9");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'de090ccf-2ed8-4d8d-8886-8737349331f9' but no matching script tag was found.")
        }

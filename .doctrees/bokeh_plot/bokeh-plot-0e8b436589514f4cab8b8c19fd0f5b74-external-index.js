(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("15fc27df-75cb-4bdf-98fe-97adb70ceca1");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '15fc27df-75cb-4bdf-98fe-97adb70ceca1' but no matching script tag was found.")
        }

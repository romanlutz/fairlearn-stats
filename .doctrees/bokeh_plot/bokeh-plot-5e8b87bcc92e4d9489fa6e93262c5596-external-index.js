(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("efe9e022-46b5-4ca0-b020-1fdb91b8b9be");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'efe9e022-46b5-4ca0-b020-1fdb91b8b9be' but no matching script tag was found.")
        }

(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("d2164c54-971e-4a0e-89c8-2214de4bba5d");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'd2164c54-971e-4a0e-89c8-2214de4bba5d' but no matching script tag was found.")
        }

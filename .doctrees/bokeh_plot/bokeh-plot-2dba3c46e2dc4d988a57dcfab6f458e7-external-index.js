(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("9f5a48b2-2c2f-4bd7-85d5-54fd74a61deb");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '9f5a48b2-2c2f-4bd7-85d5-54fd74a61deb' but no matching script tag was found.")
        }

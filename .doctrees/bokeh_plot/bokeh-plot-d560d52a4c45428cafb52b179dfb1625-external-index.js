(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("367c17c2-1bf0-4588-8254-66c7fdb7666e");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '367c17c2-1bf0-4588-8254-66c7fdb7666e' but no matching script tag was found.")
        }

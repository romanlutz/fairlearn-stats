(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("9a5cf376-4333-48d0-8cae-32277bea3108");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '9a5cf376-4333-48d0-8cae-32277bea3108' but no matching script tag was found.")
        }

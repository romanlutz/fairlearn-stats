(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("2add6d92-295c-4fe6-aa41-c888b7504408");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '2add6d92-295c-4fe6-aa41-c888b7504408' but no matching script tag was found.")
        }

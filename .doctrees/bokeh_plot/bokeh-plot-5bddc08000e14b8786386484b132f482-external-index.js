(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("6bd6a340-d987-47e1-bea2-6ffa6e99ecb1");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '6bd6a340-d987-47e1-bea2-6ffa6e99ecb1' but no matching script tag was found.")
        }

(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("f67d6be0-58c1-4ba9-b8d6-95537a8519c4");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'f67d6be0-58c1-4ba9-b8d6-95537a8519c4' but no matching script tag was found.")
        }

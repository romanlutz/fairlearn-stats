(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("78d1c1f2-2146-4ee2-8a69-325431710f52");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '78d1c1f2-2146-4ee2-8a69-325431710f52' but no matching script tag was found.")
        }

(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("800ce4b8-4a8f-44f9-8eac-ddbadd4badcb");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '800ce4b8-4a8f-44f9-8eac-ddbadd4badcb' but no matching script tag was found.")
        }

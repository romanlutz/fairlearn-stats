(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("5969c7d9-a5e7-48d7-9d3d-c3f987fc97cf");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '5969c7d9-a5e7-48d7-9d3d-c3f987fc97cf' but no matching script tag was found.")
        }

(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("a0669829-eee3-4e4d-ba1a-779496bb62a8");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'a0669829-eee3-4e4d-ba1a-779496bb62a8' but no matching script tag was found.")
        }

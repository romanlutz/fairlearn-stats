(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("85222293-2671-46dc-a133-e2cccbb60f0f");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '85222293-2671-46dc-a133-e2cccbb60f0f' but no matching script tag was found.")
        }

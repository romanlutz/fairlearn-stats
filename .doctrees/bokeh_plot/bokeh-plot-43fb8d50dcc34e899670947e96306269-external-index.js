(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("3000c21f-63a7-415c-bde0-7618313a7923");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '3000c21f-63a7-415c-bde0-7618313a7923' but no matching script tag was found.")
        }

(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("1ee2d921-bab4-4bcd-8032-44f75e9fcb56");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '1ee2d921-bab4-4bcd-8032-44f75e9fcb56' but no matching script tag was found.")
        }

(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("03f8bc43-95b7-4bc2-88ba-89da144273c0");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '03f8bc43-95b7-4bc2-88ba-89da144273c0' but no matching script tag was found.")
        }

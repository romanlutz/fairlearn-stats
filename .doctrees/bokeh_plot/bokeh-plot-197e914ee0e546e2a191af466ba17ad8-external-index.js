(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("74cc6ea0-477f-4535-b4c8-b03637305f78");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '74cc6ea0-477f-4535-b4c8-b03637305f78' but no matching script tag was found.")
        }

(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("afa8e978-f5a9-4110-9d05-564f55785998");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'afa8e978-f5a9-4110-9d05-564f55785998' but no matching script tag was found.")
        }

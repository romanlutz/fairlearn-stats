(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("92211fd7-af06-4779-b537-cab13c404876");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '92211fd7-af06-4779-b537-cab13c404876' but no matching script tag was found.")
        }

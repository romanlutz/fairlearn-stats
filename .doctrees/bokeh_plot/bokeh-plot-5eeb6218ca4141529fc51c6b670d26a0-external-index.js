(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("9de8363f-0b73-497d-86b8-c6adcd9a7491");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '9de8363f-0b73-497d-86b8-c6adcd9a7491' but no matching script tag was found.")
        }

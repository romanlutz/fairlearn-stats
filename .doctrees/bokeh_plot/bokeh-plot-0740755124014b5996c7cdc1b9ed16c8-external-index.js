(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("e39b1016-fcca-4a3b-bd5d-aef74e53f284");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'e39b1016-fcca-4a3b-bd5d-aef74e53f284' but no matching script tag was found.")
        }

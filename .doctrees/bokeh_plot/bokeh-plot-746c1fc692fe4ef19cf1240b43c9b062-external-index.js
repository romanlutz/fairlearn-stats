(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("648e1ab3-1264-46de-b3a8-0fb5905ae514");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '648e1ab3-1264-46de-b3a8-0fb5905ae514' but no matching script tag was found.")
        }

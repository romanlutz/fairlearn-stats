(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("eb01db2b-b34e-43c5-921b-475a886671ef");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'eb01db2b-b34e-43c5-921b-475a886671ef' but no matching script tag was found.")
        }

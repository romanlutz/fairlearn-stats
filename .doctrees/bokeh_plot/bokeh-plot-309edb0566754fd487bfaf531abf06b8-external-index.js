(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("b803d6e6-c757-454b-b7f0-21440bf352a7");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b803d6e6-c757-454b-b7f0-21440bf352a7' but no matching script tag was found.")
        }

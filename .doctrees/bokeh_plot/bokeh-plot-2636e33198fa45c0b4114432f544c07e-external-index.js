(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("d396c1cf-0664-463c-8ca1-f5deee54e8c5");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'd396c1cf-0664-463c-8ca1-f5deee54e8c5' but no matching script tag was found.")
        }

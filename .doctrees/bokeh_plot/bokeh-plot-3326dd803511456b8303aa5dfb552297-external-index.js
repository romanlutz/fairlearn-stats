(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("4bb05385-252b-4421-8db8-f3ad7e6b9eb1");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '4bb05385-252b-4421-8db8-f3ad7e6b9eb1' but no matching script tag was found.")
        }

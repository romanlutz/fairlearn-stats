(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("c2d1a2b7-95a7-4422-b35f-b3015f3bb46b");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'c2d1a2b7-95a7-4422-b35f-b3015f3bb46b' but no matching script tag was found.")
        }

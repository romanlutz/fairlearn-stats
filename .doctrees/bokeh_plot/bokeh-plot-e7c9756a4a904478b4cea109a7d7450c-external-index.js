(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("840c9076-70f6-4b37-923a-b2d3856b0bc2");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '840c9076-70f6-4b37-923a-b2d3856b0bc2' but no matching script tag was found.")
        }

(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("62837b5c-df80-477f-848b-4bd59addce38");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '62837b5c-df80-477f-848b-4bd59addce38' but no matching script tag was found.")
        }

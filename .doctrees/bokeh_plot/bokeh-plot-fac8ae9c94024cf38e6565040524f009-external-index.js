(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("e7e06b16-8742-4700-b18b-9d06dbacfe24");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'e7e06b16-8742-4700-b18b-9d06dbacfe24' but no matching script tag was found.")
        }

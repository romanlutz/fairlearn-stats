(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("10a3e4cd-3b59-410a-b9d6-5b560eaae9b8");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '10a3e4cd-3b59-410a-b9d6-5b560eaae9b8' but no matching script tag was found.")
        }

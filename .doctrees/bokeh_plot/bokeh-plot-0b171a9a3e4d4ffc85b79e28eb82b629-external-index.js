(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("684abbcd-7f93-45e4-b68b-29310a828cb3");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '684abbcd-7f93-45e4-b68b-29310a828cb3' but no matching script tag was found.")
        }

(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("4bbfe719-d368-4ec7-9440-575ed450d8a7");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '4bbfe719-d368-4ec7-9440-575ed450d8a7' but no matching script tag was found.")
        }

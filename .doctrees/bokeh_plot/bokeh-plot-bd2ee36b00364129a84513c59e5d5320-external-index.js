(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("bb5ac01c-0702-4243-b6e7-6d5357af1c8a");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'bb5ac01c-0702-4243-b6e7-6d5357af1c8a' but no matching script tag was found.")
        }

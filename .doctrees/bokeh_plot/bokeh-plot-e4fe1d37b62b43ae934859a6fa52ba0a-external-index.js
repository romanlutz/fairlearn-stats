(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("34fa11fb-070a-4660-ad12-53650874fee2");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '34fa11fb-070a-4660-ad12-53650874fee2' but no matching script tag was found.")
        }

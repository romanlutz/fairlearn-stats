(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("cddf35d4-5213-4c27-bccf-3c29f212bd81");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'cddf35d4-5213-4c27-bccf-3c29f212bd81' but no matching script tag was found.")
        }

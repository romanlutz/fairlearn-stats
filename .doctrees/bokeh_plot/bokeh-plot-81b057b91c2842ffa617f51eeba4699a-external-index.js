(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("bf3e9a9a-e8a5-4af8-ad9b-0cff8ad188ff");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'bf3e9a9a-e8a5-4af8-ad9b-0cff8ad188ff' but no matching script tag was found.")
        }

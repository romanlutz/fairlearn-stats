(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("a16a4782-6abf-46d9-9cd3-06d0aa8f0b80");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'a16a4782-6abf-46d9-9cd3-06d0aa8f0b80' but no matching script tag was found.")
        }

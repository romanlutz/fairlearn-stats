(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("3b256aac-e08c-47b8-a2a3-c59eddd7491c");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '3b256aac-e08c-47b8-a2a3-c59eddd7491c' but no matching script tag was found.")
        }

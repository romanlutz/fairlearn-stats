(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("061c9d22-acd2-4104-b26b-1ee5d7b1426a");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '061c9d22-acd2-4104-b26b-1ee5d7b1426a' but no matching script tag was found.")
        }

(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("3a8fa040-d4a3-4678-a6ce-006ba03dc35a");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '3a8fa040-d4a3-4678-a6ce-006ba03dc35a' but no matching script tag was found.")
        }

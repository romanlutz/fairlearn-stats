(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("b260cf50-2f1e-493d-ac61-fc7b3e9b242d");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b260cf50-2f1e-493d-ac61-fc7b3e9b242d' but no matching script tag was found.")
        }

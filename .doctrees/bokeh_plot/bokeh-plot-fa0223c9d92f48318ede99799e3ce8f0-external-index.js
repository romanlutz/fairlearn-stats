(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("3e4e8bc3-1188-4dbf-be8c-95c4043bd5f4");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '3e4e8bc3-1188-4dbf-be8c-95c4043bd5f4' but no matching script tag was found.")
        }

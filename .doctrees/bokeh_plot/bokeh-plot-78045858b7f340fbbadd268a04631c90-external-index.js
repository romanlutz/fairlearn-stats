(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("d3e6a560-dc56-4f5d-aceb-19336a6ee390");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'd3e6a560-dc56-4f5d-aceb-19336a6ee390' but no matching script tag was found.")
        }

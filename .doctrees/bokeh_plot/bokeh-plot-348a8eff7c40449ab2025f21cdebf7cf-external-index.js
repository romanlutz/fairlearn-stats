(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("af88c658-bc0d-41a9-90e9-da4fd16941ce");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'af88c658-bc0d-41a9-90e9-da4fd16941ce' but no matching script tag was found.")
        }

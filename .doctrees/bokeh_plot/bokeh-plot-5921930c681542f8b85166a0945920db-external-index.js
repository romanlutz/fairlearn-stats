(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("f955c12e-d5fa-4057-833f-707fdf4d43d8");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'f955c12e-d5fa-4057-833f-707fdf4d43d8' but no matching script tag was found.")
        }

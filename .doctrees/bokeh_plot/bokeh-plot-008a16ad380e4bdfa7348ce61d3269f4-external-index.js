(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("de0ffe2e-79c8-4b69-8294-67d1f82f8e25");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'de0ffe2e-79c8-4b69-8294-67d1f82f8e25' but no matching script tag was found.")
        }

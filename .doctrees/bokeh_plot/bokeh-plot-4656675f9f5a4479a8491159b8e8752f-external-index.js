(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("d88351fa-4863-4695-acae-546a43795577");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'd88351fa-4863-4695-acae-546a43795577' but no matching script tag was found.")
        }

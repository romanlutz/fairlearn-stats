(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("2e5a660b-107d-4bf9-aa2b-bf55fef39206");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '2e5a660b-107d-4bf9-aa2b-bf55fef39206' but no matching script tag was found.")
        }

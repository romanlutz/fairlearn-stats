(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("d84fad4a-bd2c-422d-97f7-8366e04c8704");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'd84fad4a-bd2c-422d-97f7-8366e04c8704' but no matching script tag was found.")
        }

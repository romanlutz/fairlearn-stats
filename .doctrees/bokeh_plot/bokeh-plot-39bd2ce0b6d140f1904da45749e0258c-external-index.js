(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("3f584830-b6d3-4046-b65e-86872e41b49c");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '3f584830-b6d3-4046-b65e-86872e41b49c' but no matching script tag was found.")
        }

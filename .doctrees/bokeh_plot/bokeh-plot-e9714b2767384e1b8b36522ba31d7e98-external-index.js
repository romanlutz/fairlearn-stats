(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("27955df9-4e88-42c9-8aac-bba05cdb5aba");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '27955df9-4e88-42c9-8aac-bba05cdb5aba' but no matching script tag was found.")
        }

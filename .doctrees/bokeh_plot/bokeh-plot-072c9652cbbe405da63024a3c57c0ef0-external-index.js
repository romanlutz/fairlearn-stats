(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("e44c908e-5ecb-4590-9a24-9569e93fd085");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'e44c908e-5ecb-4590-9a24-9569e93fd085' but no matching script tag was found.")
        }

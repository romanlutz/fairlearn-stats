(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("ebd60573-13c9-4012-93c6-d35be2691f6f");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'ebd60573-13c9-4012-93c6-d35be2691f6f' but no matching script tag was found.")
        }

(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("6bd8e809-c6a6-425b-84f8-ca8761e42c0d");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '6bd8e809-c6a6-425b-84f8-ca8761e42c0d' but no matching script tag was found.")
        }

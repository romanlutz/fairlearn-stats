(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("dcabb598-94bf-40b2-b4b2-f5051f6fe2bf");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'dcabb598-94bf-40b2-b4b2-f5051f6fe2bf' but no matching script tag was found.")
        }

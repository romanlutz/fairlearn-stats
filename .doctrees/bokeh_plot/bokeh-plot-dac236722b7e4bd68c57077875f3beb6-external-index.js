(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("8985a8ea-55e3-45b9-9a12-57b6a5bbea6c");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '8985a8ea-55e3-45b9-9a12-57b6a5bbea6c' but no matching script tag was found.")
        }

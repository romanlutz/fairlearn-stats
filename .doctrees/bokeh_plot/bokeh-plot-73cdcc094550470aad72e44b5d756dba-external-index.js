(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("81030be5-fba6-4e27-ad13-ece98e3f64be");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '81030be5-fba6-4e27-ad13-ece98e3f64be' but no matching script tag was found.")
        }

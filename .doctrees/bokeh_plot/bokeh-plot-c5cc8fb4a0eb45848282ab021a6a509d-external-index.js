(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("ed1f0278-9e4a-4d9d-8250-b0bc73ce1f26");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'ed1f0278-9e4a-4d9d-8250-b0bc73ce1f26' but no matching script tag was found.")
        }

(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("c36e9160-3192-4f61-b65f-80d16284eb01");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'c36e9160-3192-4f61-b65f-80d16284eb01' but no matching script tag was found.")
        }

(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("93ef90d2-57ed-4e92-9b0f-9aefbef215ef");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '93ef90d2-57ed-4e92-9b0f-9aefbef215ef' but no matching script tag was found.")
        }

(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("878247d0-817e-490e-a81a-81a099f5e2e6");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '878247d0-817e-490e-a81a-81a099f5e2e6' but no matching script tag was found.")
        }

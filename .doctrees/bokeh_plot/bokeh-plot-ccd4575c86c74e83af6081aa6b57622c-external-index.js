(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("716606fc-5a84-43d7-9c97-74c22c27d1bb");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '716606fc-5a84-43d7-9c97-74c22c27d1bb' but no matching script tag was found.")
        }

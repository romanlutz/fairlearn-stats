(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("deab03df-6dbc-4cea-9a9b-f144b7cda466");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'deab03df-6dbc-4cea-9a9b-f144b7cda466' but no matching script tag was found.")
        }

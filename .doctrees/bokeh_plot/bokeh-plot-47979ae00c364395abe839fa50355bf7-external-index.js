(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("ef070ec7-64fe-43d7-a837-4069b0585685");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'ef070ec7-64fe-43d7-a837-4069b0585685' but no matching script tag was found.")
        }

(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("1818b6c9-d319-4906-8605-ebf443b8478a");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '1818b6c9-d319-4906-8605-ebf443b8478a' but no matching script tag was found.")
        }

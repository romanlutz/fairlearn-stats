(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("6e4419b3-46a2-466f-9c62-6965b43ca615");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '6e4419b3-46a2-466f-9c62-6965b43ca615' but no matching script tag was found.")
        }

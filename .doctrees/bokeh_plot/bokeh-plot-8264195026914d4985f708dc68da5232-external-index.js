(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("1ef3262c-ef3c-4dc1-b219-5114c687ae1d");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '1ef3262c-ef3c-4dc1-b219-5114c687ae1d' but no matching script tag was found.")
        }

(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("63da75d9-d006-4bff-a345-77d96efaa155");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '63da75d9-d006-4bff-a345-77d96efaa155' but no matching script tag was found.")
        }

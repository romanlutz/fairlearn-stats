(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("6eb82536-8627-4b68-866c-39b2d57f3bbf");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '6eb82536-8627-4b68-866c-39b2d57f3bbf' but no matching script tag was found.")
        }

(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("8b46907b-5ea2-40df-9583-eadafc3b06ff");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '8b46907b-5ea2-40df-9583-eadafc3b06ff' but no matching script tag was found.")
        }

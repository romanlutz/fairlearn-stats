(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("06a92520-9e92-4060-a468-6a1fa0c2a101");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '06a92520-9e92-4060-a468-6a1fa0c2a101' but no matching script tag was found.")
        }

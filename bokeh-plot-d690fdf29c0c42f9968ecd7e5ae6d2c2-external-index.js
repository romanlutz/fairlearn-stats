(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("91a8802c-73d4-42eb-95d1-28c766d0918f");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '91a8802c-73d4-42eb-95d1-28c766d0918f' but no matching script tag was found.")
        }

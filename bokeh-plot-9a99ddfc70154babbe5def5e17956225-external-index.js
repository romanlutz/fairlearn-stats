(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("df697f11-c62d-4de8-b819-a446543efe22");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'df697f11-c62d-4de8-b819-a446543efe22' but no matching script tag was found.")
        }

(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("2ee3e1ad-73da-4576-ad28-1090e511dde2");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '2ee3e1ad-73da-4576-ad28-1090e511dde2' but no matching script tag was found.")
        }

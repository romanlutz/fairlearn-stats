(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("88a2d13b-469e-4f6a-98f0-33dc63b7c780");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '88a2d13b-469e-4f6a-98f0-33dc63b7c780' but no matching script tag was found.")
        }

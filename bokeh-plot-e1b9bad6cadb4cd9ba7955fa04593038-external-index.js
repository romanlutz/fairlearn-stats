(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("d94cad8f-15b5-4d15-a9a3-284da2d0fca7");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'd94cad8f-15b5-4d15-a9a3-284da2d0fca7' but no matching script tag was found.")
        }

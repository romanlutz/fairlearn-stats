(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("13d0933b-4513-4bcc-b60d-108ed2f43793");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '13d0933b-4513-4bcc-b60d-108ed2f43793' but no matching script tag was found.")
        }

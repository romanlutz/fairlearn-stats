(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("f6469be9-4e7d-4494-85b8-15607b1039ca");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'f6469be9-4e7d-4494-85b8-15607b1039ca' but no matching script tag was found.")
        }

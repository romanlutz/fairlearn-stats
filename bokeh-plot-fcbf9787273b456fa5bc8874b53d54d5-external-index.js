(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("b650e7ac-1558-4466-a0b6-5d9b30713619");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b650e7ac-1558-4466-a0b6-5d9b30713619' but no matching script tag was found.")
        }

(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("25c878e4-edbb-4acf-a91b-0a6333ab84d4");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '25c878e4-edbb-4acf-a91b-0a6333ab84d4' but no matching script tag was found.")
        }

(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("31a8348a-e420-4736-a8c2-bcb2cd67d07d");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '31a8348a-e420-4736-a8c2-bcb2cd67d07d' but no matching script tag was found.")
        }

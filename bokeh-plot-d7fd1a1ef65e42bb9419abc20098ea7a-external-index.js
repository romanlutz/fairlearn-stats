(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("31a806a9-4131-4478-b572-0b0486976d4f");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '31a806a9-4131-4478-b572-0b0486976d4f' but no matching script tag was found.")
        }

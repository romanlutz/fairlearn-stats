(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("4daf9da1-310e-4dc1-9e92-ed698be3d7ea");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '4daf9da1-310e-4dc1-9e92-ed698be3d7ea' but no matching script tag was found.")
        }

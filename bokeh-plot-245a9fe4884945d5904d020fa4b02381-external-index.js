(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("e5a57ce3-b2a1-4600-868e-1d452cb37abe");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'e5a57ce3-b2a1-4600-868e-1d452cb37abe' but no matching script tag was found.")
        }

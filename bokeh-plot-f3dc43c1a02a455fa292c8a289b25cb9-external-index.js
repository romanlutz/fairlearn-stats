(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("9666b6b1-8c3b-4bc0-8879-757494fd5d74");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '9666b6b1-8c3b-4bc0-8879-757494fd5d74' but no matching script tag was found.")
        }

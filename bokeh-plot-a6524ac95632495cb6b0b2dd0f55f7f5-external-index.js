(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("ff1f035b-d86a-4310-8f16-c2835207fb6e");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'ff1f035b-d86a-4310-8f16-c2835207fb6e' but no matching script tag was found.")
        }

(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("1debcd96-0d49-4dd2-b179-231d215637c3");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '1debcd96-0d49-4dd2-b179-231d215637c3' but no matching script tag was found.")
        }

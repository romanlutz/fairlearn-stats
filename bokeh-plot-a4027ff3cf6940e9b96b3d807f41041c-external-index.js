(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("508811b9-c3ca-432e-9be6-06fd2aa6b819");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '508811b9-c3ca-432e-9be6-06fd2aa6b819' but no matching script tag was found.")
        }

(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("3c9cb29a-7702-4341-bff8-8e77a4f40d0b");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '3c9cb29a-7702-4341-bff8-8e77a4f40d0b' but no matching script tag was found.")
        }

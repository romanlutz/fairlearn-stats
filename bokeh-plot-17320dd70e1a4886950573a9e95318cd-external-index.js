(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("dbcd05fb-e441-42e5-aaa4-e1213e985c36");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'dbcd05fb-e441-42e5-aaa4-e1213e985c36' but no matching script tag was found.")
        }

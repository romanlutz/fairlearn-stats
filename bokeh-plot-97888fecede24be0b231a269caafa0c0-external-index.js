(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("45b9010b-4721-4df2-9607-1f4702e5e743");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '45b9010b-4721-4df2-9607-1f4702e5e743' but no matching script tag was found.")
        }

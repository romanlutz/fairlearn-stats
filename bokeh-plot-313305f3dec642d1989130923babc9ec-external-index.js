(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("00400729-d641-412f-90bd-c458bfd2a31f");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '00400729-d641-412f-90bd-c458bfd2a31f' but no matching script tag was found.")
        }

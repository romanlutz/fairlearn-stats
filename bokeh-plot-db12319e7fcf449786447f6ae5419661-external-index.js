(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("f3a1951c-c39c-43cd-88dc-7352421794bd");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'f3a1951c-c39c-43cd-88dc-7352421794bd' but no matching script tag was found.")
        }

(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("6a146147-3e21-418f-a049-025ada6e3e84");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '6a146147-3e21-418f-a049-025ada6e3e84' but no matching script tag was found.")
        }

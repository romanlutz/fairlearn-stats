(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("4e564bbc-8899-4256-8ec6-3d2321b9362d");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '4e564bbc-8899-4256-8ec6-3d2321b9362d' but no matching script tag was found.")
        }

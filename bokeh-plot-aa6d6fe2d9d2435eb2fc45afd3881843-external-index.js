(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("52cfd495-989e-4662-85de-29a742037eda");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '52cfd495-989e-4662-85de-29a742037eda' but no matching script tag was found.")
        }

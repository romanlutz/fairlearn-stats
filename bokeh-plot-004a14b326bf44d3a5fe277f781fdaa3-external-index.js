(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("68544a47-c992-464b-9a06-221c6369ffbc");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '68544a47-c992-464b-9a06-221c6369ffbc' but no matching script tag was found.")
        }

(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("c20853d5-91a1-429b-980e-84446bd0e634");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'c20853d5-91a1-429b-980e-84446bd0e634' but no matching script tag was found.")
        }

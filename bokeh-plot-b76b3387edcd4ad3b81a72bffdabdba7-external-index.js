(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("179a54c3-377d-4684-90ae-8f0260ddd581");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '179a54c3-377d-4684-90ae-8f0260ddd581' but no matching script tag was found.")
        }

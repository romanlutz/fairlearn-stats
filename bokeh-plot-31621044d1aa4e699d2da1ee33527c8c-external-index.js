(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("1e7782af-9a7c-44f1-b4d1-6203aa74300a");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '1e7782af-9a7c-44f1-b4d1-6203aa74300a' but no matching script tag was found.")
        }

(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("fb91f175-06ce-48f8-860e-4f0ba2b22036");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'fb91f175-06ce-48f8-860e-4f0ba2b22036' but no matching script tag was found.")
        }

(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("4c9a793b-d9f2-403a-b393-66b84b03365f");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '4c9a793b-d9f2-403a-b393-66b84b03365f' but no matching script tag was found.")
        }

(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("48043bf8-127e-4335-9243-73fcd0015354");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '48043bf8-127e-4335-9243-73fcd0015354' but no matching script tag was found.")
        }

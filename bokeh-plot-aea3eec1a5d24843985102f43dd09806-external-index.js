(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("a60862ef-d8df-4732-84b2-8b570f6ed629");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'a60862ef-d8df-4732-84b2-8b570f6ed629' but no matching script tag was found.")
        }

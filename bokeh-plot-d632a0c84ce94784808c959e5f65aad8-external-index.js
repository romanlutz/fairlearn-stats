(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("7705fba5-5a4a-49dc-a145-b779f71bcafa");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '7705fba5-5a4a-49dc-a145-b779f71bcafa' but no matching script tag was found.")
        }

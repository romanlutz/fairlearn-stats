(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("6fbe045a-ef73-45ab-aa96-f3028aae5df9");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '6fbe045a-ef73-45ab-aa96-f3028aae5df9' but no matching script tag was found.")
        }

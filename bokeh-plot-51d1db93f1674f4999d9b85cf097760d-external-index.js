(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("17976dcf-ab64-4356-9b7a-76311de6e9a1");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '17976dcf-ab64-4356-9b7a-76311de6e9a1' but no matching script tag was found.")
        }

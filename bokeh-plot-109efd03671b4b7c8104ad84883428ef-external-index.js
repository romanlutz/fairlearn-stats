(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("0038c2f4-599b-4581-8aec-d2ace0b6c737");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '0038c2f4-599b-4581-8aec-d2ace0b6c737' but no matching script tag was found.")
        }

(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("7e41169b-2038-456b-aeb2-f3b2d088c7de");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '7e41169b-2038-456b-aeb2-f3b2d088c7de' but no matching script tag was found.")
        }

(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("2d716b09-289b-480b-9634-3705464ed375");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '2d716b09-289b-480b-9634-3705464ed375' but no matching script tag was found.")
        }

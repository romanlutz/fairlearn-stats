(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("c1589956-dc86-4de5-b152-93223210baf8");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'c1589956-dc86-4de5-b152-93223210baf8' but no matching script tag was found.")
        }

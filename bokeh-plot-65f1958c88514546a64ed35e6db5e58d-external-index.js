(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("ee0aada3-1e05-4370-9dce-28e5e7f94fed");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'ee0aada3-1e05-4370-9dce-28e5e7f94fed' but no matching script tag was found.")
        }

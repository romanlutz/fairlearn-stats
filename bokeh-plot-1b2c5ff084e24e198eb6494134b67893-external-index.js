(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("d7012cec-e110-4f34-b55c-ebaafbc3040a");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'd7012cec-e110-4f34-b55c-ebaafbc3040a' but no matching script tag was found.")
        }

(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("e5a6c349-c80b-490d-b61b-330ef71a1c07");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'e5a6c349-c80b-490d-b61b-330ef71a1c07' but no matching script tag was found.")
        }

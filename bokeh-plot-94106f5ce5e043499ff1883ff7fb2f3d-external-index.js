(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("112acc4d-319a-4b63-aced-255b39710789");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '112acc4d-319a-4b63-aced-255b39710789' but no matching script tag was found.")
        }

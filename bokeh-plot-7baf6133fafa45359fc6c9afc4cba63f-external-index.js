(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("b3f422da-e260-4036-b7c3-49d8f1bd3a35");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b3f422da-e260-4036-b7c3-49d8f1bd3a35' but no matching script tag was found.")
        }

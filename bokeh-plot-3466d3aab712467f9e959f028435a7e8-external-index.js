(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("e6e16494-9d37-46dc-b1b8-2fa469d40d7b");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'e6e16494-9d37-46dc-b1b8-2fa469d40d7b' but no matching script tag was found.")
        }

(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("3a0ca6f1-5348-46ce-8a37-f11de76ef083");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '3a0ca6f1-5348-46ce-8a37-f11de76ef083' but no matching script tag was found.")
        }

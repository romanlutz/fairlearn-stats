(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("c01eee25-181e-43f5-9848-942dc94f63ac");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'c01eee25-181e-43f5-9848-942dc94f63ac' but no matching script tag was found.")
        }

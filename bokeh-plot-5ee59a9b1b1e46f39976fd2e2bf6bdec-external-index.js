(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("64fd9be4-897a-4813-aeeb-fe476017d307");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '64fd9be4-897a-4813-aeeb-fe476017d307' but no matching script tag was found.")
        }

(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("591fde52-ec1f-47cf-ba64-178106f3da30");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '591fde52-ec1f-47cf-ba64-178106f3da30' but no matching script tag was found.")
        }

(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("c82102a8-7b1c-4bf1-8ed3-a916ec5da76b");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'c82102a8-7b1c-4bf1-8ed3-a916ec5da76b' but no matching script tag was found.")
        }

(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("0d2ef39a-d466-41e0-a8ce-2b64b2594f2a");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '0d2ef39a-d466-41e0-a8ce-2b64b2594f2a' but no matching script tag was found.")
        }

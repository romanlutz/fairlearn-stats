(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("efc3a364-9093-4bea-9166-f456cdf7c750");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'efc3a364-9093-4bea-9166-f456cdf7c750' but no matching script tag was found.")
        }

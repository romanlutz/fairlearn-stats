(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("dbc72afb-df7d-4658-83a6-75f920bce295");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'dbc72afb-df7d-4658-83a6-75f920bce295' but no matching script tag was found.")
        }

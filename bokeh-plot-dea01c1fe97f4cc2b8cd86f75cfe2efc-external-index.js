(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("ab6814d6-389f-4fac-a98b-75fd813e53cd");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'ab6814d6-389f-4fac-a98b-75fd813e53cd' but no matching script tag was found.")
        }

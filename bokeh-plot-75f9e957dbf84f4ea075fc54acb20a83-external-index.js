(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("475ff3e3-83fa-4df7-a2d1-7c06258f67d0");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '475ff3e3-83fa-4df7-a2d1-7c06258f67d0' but no matching script tag was found.")
        }

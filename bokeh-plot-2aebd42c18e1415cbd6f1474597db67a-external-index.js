(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("ba528bd2-be32-4f45-9776-d00aa0f2e333");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'ba528bd2-be32-4f45-9776-d00aa0f2e333' but no matching script tag was found.")
        }

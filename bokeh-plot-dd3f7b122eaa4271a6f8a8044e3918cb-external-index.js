(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("5ef7a1de-42f8-42a3-ab90-4aa53603c210");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '5ef7a1de-42f8-42a3-ab90-4aa53603c210' but no matching script tag was found.")
        }

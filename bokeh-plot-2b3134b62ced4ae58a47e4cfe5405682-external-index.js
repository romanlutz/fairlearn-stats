(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("a0eeb425-4b97-4bdf-8fb9-d37c60935900");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'a0eeb425-4b97-4bdf-8fb9-d37c60935900' but no matching script tag was found.")
        }

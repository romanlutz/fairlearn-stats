(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("c37c0995-fb45-4d09-91ba-94ebe08a2a41");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'c37c0995-fb45-4d09-91ba-94ebe08a2a41' but no matching script tag was found.")
        }

(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("0067a53f-f53f-4d0c-bf0e-f17acb6fd9b1");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '0067a53f-f53f-4d0c-bf0e-f17acb6fd9b1' but no matching script tag was found.")
        }

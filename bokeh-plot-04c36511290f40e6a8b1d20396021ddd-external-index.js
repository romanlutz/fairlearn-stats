(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("559c12c0-f89e-4ced-8add-99c0cb2570f3");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '559c12c0-f89e-4ced-8add-99c0cb2570f3' but no matching script tag was found.")
        }

(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("c63c47dc-4693-446b-8191-c764da421a5a");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'c63c47dc-4693-446b-8191-c764da421a5a' but no matching script tag was found.")
        }

(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("7bf29d86-530b-489d-9173-bd72156c0034");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '7bf29d86-530b-489d-9173-bd72156c0034' but no matching script tag was found.")
        }

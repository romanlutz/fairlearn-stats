(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("36ccda16-eb9e-421d-929c-aa269b239cdf");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '36ccda16-eb9e-421d-929c-aa269b239cdf' but no matching script tag was found.")
        }

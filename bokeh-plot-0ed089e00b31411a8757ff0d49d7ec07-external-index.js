(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("cee7db13-c463-4cbf-b415-7cfe6e7b1c33");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'cee7db13-c463-4cbf-b415-7cfe6e7b1c33' but no matching script tag was found.")
        }

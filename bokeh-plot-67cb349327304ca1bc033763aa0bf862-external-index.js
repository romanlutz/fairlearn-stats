(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("bf0d3b63-6b0e-4cc1-aa43-24d0e7e67eee");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'bf0d3b63-6b0e-4cc1-aa43-24d0e7e67eee' but no matching script tag was found.")
        }

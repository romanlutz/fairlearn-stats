(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("c064c49c-23ba-4b7f-85a8-60fd66f267eb");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'c064c49c-23ba-4b7f-85a8-60fd66f267eb' but no matching script tag was found.")
        }

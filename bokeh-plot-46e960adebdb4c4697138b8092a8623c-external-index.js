(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("b0f59a15-1257-4009-a530-5a53272aed8d");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b0f59a15-1257-4009-a530-5a53272aed8d' but no matching script tag was found.")
        }

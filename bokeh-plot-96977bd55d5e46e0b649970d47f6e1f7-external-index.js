(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("0e1046f7-e192-4ad4-979e-f5b01582f9fc");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '0e1046f7-e192-4ad4-979e-f5b01582f9fc' but no matching script tag was found.")
        }

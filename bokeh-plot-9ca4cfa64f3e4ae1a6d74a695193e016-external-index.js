(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("085a2f47-dbea-4493-aaed-07773006b5d7");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '085a2f47-dbea-4493-aaed-07773006b5d7' but no matching script tag was found.")
        }

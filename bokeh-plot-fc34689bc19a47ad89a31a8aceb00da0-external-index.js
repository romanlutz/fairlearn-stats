(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("a2a1dd08-2c40-4cc7-afd2-65dc2b26ea84");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'a2a1dd08-2c40-4cc7-afd2-65dc2b26ea84' but no matching script tag was found.")
        }

(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("ef91dcc2-1ea7-4282-ad46-4630cbf0ffc2");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'ef91dcc2-1ea7-4282-ad46-4630cbf0ffc2' but no matching script tag was found.")
        }

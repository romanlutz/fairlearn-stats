(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("3a03fcfe-6238-4b21-968f-28cbadd757c5");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '3a03fcfe-6238-4b21-968f-28cbadd757c5' but no matching script tag was found.")
        }

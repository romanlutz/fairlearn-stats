(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("020030d9-4f59-4785-8d84-3551c137bb71");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '020030d9-4f59-4785-8d84-3551c137bb71' but no matching script tag was found.")
        }

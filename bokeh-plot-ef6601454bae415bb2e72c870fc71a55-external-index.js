(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("5876bcb6-6186-45e4-8bad-1997c95bd0f9");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '5876bcb6-6186-45e4-8bad-1997c95bd0f9' but no matching script tag was found.")
        }

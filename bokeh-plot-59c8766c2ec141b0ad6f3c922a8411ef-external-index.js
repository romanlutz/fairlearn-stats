(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("f284462a-96bc-4a94-94c8-80cbc4c1624b");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'f284462a-96bc-4a94-94c8-80cbc4c1624b' but no matching script tag was found.")
        }

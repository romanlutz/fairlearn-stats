(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("31f04bbd-32d4-44cd-ac53-a62e34cf4ff8");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '31f04bbd-32d4-44cd-ac53-a62e34cf4ff8' but no matching script tag was found.")
        }

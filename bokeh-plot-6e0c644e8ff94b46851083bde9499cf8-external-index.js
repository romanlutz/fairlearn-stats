(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("5f684e07-c97b-411a-a475-73b8de0bfbbf");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '5f684e07-c97b-411a-a475-73b8de0bfbbf' but no matching script tag was found.")
        }

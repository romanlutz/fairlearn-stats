(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("db8e2b8f-cb15-4e12-a320-4af3a865bd23");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'db8e2b8f-cb15-4e12-a320-4af3a865bd23' but no matching script tag was found.")
        }

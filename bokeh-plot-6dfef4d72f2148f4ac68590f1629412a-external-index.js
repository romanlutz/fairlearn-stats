(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("f59de380-f1f6-4ab0-ac71-dede791a2327");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'f59de380-f1f6-4ab0-ac71-dede791a2327' but no matching script tag was found.")
        }

(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("daa2d68b-e89e-46b3-99ff-5949b12cd974");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'daa2d68b-e89e-46b3-99ff-5949b12cd974' but no matching script tag was found.")
        }

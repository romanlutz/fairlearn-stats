(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("aa851192-2d50-41b3-9704-9086ed91f725");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'aa851192-2d50-41b3-9704-9086ed91f725' but no matching script tag was found.")
        }

(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("5767222e-6f65-49e0-a7ff-d7cc2983cb6d");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '5767222e-6f65-49e0-a7ff-d7cc2983cb6d' but no matching script tag was found.")
        }

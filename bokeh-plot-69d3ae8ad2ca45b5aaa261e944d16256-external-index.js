(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("884e683e-5b19-4bab-83d7-158b30bab339");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '884e683e-5b19-4bab-83d7-158b30bab339' but no matching script tag was found.")
        }

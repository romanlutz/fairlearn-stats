(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("98aa1247-06ab-4fee-a082-b25e7fd99784");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '98aa1247-06ab-4fee-a082-b25e7fd99784' but no matching script tag was found.")
        }

(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("b2796e30-6d3d-4b35-a053-459664f01a4d");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b2796e30-6d3d-4b35-a053-459664f01a4d' but no matching script tag was found.")
        }

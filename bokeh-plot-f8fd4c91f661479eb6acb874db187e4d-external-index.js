(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("875a2633-db14-496d-99f8-dc52e49d1112");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '875a2633-db14-496d-99f8-dc52e49d1112' but no matching script tag was found.")
        }

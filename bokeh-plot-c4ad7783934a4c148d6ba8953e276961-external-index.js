(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("76edaef4-012e-4035-8eb4-18e176a2ad88");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '76edaef4-012e-4035-8eb4-18e176a2ad88' but no matching script tag was found.")
        }
